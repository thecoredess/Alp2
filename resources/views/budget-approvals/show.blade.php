        ...
        <div class="space-y-4">
            ...
            <div class="card p-5">
                ...
                <dl class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between"><dt class="text-gray-500">Diluluskan</dt><dd class="text-amber-600"><x-money :value="$summary->committed" /></dd></div>
                    <div class="flex justify-between"><dt class="text-gray-500">Peruntukan Permohonan Dalam Proses (Belum diluluskan)</dt><dd class="text-orange-600"><x-money :value="$pending" /></dd></div>
