@extends('layouts.app')
@section('title', $reviewType->label())
@section('heading', 'Menunggu '.$reviewType->label())
    ...
    <div class="card overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                    <tr><td colspan="7" class="px-4 py-10 text-center text-gray-400">Tiada permohonan menunggu {{ $reviewType->label() }}.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
