...
> **DIGANTI / BUKAN SSOT (5 Sep 2026):** Dokumen ini merujuk model Hybrid v1.0/v1.1.  
> **SSOT semasa = URS v1.2** — gunakan [PANDUAN_ANALISIS_URS_v1.2.md](PANDUAN_ANALISIS_URS_v1.2.md), [URS_v1.2_REFACTORING_PLAN.md](URS_v1.2_REFACTORING_PLAN.md), [UAT_CHECKLIST.md](UAT_CHECKLIST.md).  
> Simpan fail ini untuk sejarah keputusan Hybrid sahaja; **jangan** gunakan sebagai skop production.
